...
function Category() {
  ...
  let getcategory = () => axios.get(`/api/category?s_id=${search.s_id}&s_name=${search.s_name}`).then((res) => res.data)
  ...
  const handledelete = async (e) => {
    let result = await axios.post(`/api/admin/deletecate`, { id: category.id })
